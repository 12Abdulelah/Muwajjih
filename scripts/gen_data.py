...
DEPARTMENTS = {
    ...
    "lighting": {
        "issues": [
            ...
            "broken light pole",
            "dark street",
            "several lights are off",
            "street lamp is damaged",
        ],
        "places": [
            "park entrance",
            "residential street",
        ...
        "effects": [
            "area is very dark",
            "visibility is poor",
            "pedestrians cannot see well",
            "drivers struggle at night",
            "has been dark for days",
            "needs repair",
        ],
    },
    "waste": {
    ...
    "water": {
        "issues": [
            ...
            "no water is reaching homes",
            "clean water is flooding the street",
            "water meter area is leaking",
    ...
    "sewage": {
        "issues": [
            ...
            "sewer drain is blocked",
            "wastewater is backing up",
            "sewer cover is leaking",
            "drain smells strongly",
            "sewage water is in the street",
        ],
        "places": [
            "near our homes",
            "at the intersection",
    ...
    "parks": {
        "issues": [
            ...
            "park irrigation is damaged",
            "grass is dying",
            "park bench is broken",
            "play area is dirty",
            "tree branch is blocking the path",
        ],
        "places": [
            "community park",
            "children's park",
        ...
        "effects": [
            "children cannot use it safely",
            "needs maintenance",
            "looks neglected",
            "blocks the walkway",
            "has been damaged for days",
            "needs cleaning",
        ],
    },
    "building": {
        "issues": [
            "construction debris is blocking access",
            "building work appears unsafe",
            "wall is cracked",
            "abandoned building is deteriorating",
            "construction fence is damaged",
            "unauthorized structure blocks the walkway",
        ],
        "places": [
            "next door",
            "near the sidewalk",
        ...
        "effects": [
            "debris reaches the road",
            "people cannot pass safely",
            "parts may fall",
            "work continues late",
            "site needs inspection",
            "hazard is visible",
        ],
    },
    "public_safety": {
        "issues": [
            "fire in a building",
            "gas leak",
            "smoke coming from a utility box",
            "fallen electrical cable",
            "dangerous exposed wires",
            "traffic signal is hanging loose",
        ],
        "places": [
            "near my building",
            "at the intersection",
...
PREFIXES = [
    ...
    "There is",
    "We have",
    "Can the municipality inspect",
    "A complaint about",
    "Please send a team for",
...
SUFFIXES = [
    ...
    "we need assistance",
    "please send maintenance",
    "this needs attention",
    "please handle it soon",
    "kindly investigate",
...
def main() -> None:
    ...
    output = Path(__file__).resolve().parents[1] / "data" / "synthetic.csv"
    ...
    with output.open("w", newline="", encoding="utf-8") as handle:
        writer = csv.DictWriter(
            handle, fieldnames=["record_id", "complaint", "department", "data_source"]
        )
        writer.writeheader()
